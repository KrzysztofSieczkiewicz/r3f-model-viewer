...
import { LightProperties } from "../../../models/Light";
...
// TODO: MERGE THIS AND LightsGizmo.tsx into single "PositionGizmo"
export const CamerasGizmo = ( {position, handleChange}: Props) => {
