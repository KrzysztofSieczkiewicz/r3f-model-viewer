...
export function SceneMenu() {
    ...
    //LightsService.updateLight(lightsList, light.id, {...light, visible: !light.visible})
    //
    return (
        <div className="dropdown">
            ...
            <section className="scene-section dropdown-item">
                ...
                <ColorPicker name="Color"
                    ...
                    handleChange={(val) => setScene('ambientLight.color', val)}
                />
                <Slider name="Intensity"
                    value={scene.ambientLight.intensity}
                    handleChange={(val) => setScene('ambientLight.intensity', val)}
